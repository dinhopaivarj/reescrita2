...
- SEMPRE inclua resumo inicial de 2-3 linhas destacado no topo
...
- SEMPRE cite fontes confiáveis (.gov, .edu, empresas estabelecidas, empresas internacionais)
...
- SEMPRE cite organizações confiáveis (SEBRAE, BNDES, universidades, empresas internacionais)
...
6. LINGUAGEM ULTRA POPULAR:
   - Use apenas palavras simples que todos entendam
   - Frases de no máximo 15 palavras
   - Tom de conversa amigável e natural
   - Exemplos do dia a dia, locais ou internacionais
...
8. CONTEÚDO MÍNIMO:
   - Mínimo 1000 palavras (ideal 1800+)
...
- Pelo menos 2 fontes confiáveis (podem ser brasileiras ou internacionais: .gov, .edu, organizações estabelecidas)
- Pelo menos 2 especialistas/autoridades reconhecidas (nacionais ou internacionais)
- Dados estatísticos verificáveis, atualizados
- Estudos de caso reais brasileiros ou globais relevantes
- Menções a entidades confiáveis (universidades, órgãos públicos, grandes empresas)
- Glossário automático ao final do artigo explicando termos-chave
- Q&A robusto (8+ perguntas)
- Estrutura clara para IA, SEO GEO e citações automáticas
...
Responda APENAS com um JSON válido seguindo TODAS as regras SEO GEO + RankMath + Quality Analyzer:
{
  ...
  "citations": [
  {"type": "study", "text": "Estudo da WHO sobre saúde global", "suggestedLink": "https://www.who.int", "credibility": "high"},
  {"type": "statistic", "text": "85% das empresas brasileiras", "suggestedLink": "https://ibge.gov.br", "credibility": "high"},
  {"type": "expert", "text": "Segundo especialista Neil Patel", "suggestedLink": "https://neilpatel.com", "credibility": "high"}
],
